defmodule PingCRM.Core.DataCase do
  @moduledoc """
  ...
  by setting `use PingCRM.Core.DataCase, async: true`.
  """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PingCRM.Core.DataCase
    end
  end

  setup tags do
    PingCRM.Core.DataCase.setup_sandbox(tags)
    :ok
  end
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(PingCRM.Core.Repo, shared: not tags[:async])
